<div id="simpleTabs-content-4" class="simpleTabs-content">
    <table class='form-table'>
        ...
        echo PostieAdmin::boolean_select_html(__("Image Location", 'postie'), "postie-settings[images_append]", $images_append, __("Location of attachments if using 'plain' format. Before or After content. For 'html' content this will only affect attachments that are not inline.", 'postie'), array(__('After', 'postie'), __('Before', 'postie')));
