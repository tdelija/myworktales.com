				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="mm-panel-primary" class="postbox">
						...
						<div class="toggle<?php if (!isset($_GET['settings-updated'])) echo ' default-hidden'; ?>">
							...
							<div class="mm-table-wrap">
								...
								<table class="widefat mm-table">
									...
									<tr>
										...
										<code>%%edit_link%%</code>, <code>%%user_email%%</code>, <code>%%user_url%%</code>, <code>%%custom_field%%</code>, <code>%%custom_field_2%%</code></div></td>
									</tr>
									<tr>
							...
							<h3><?php esc_html_e('Frontend Display', 'usp'); ?></h3>
							<div class="mm-table-wrap">
...
[/usp_visitor]</pre>
					...
					<div id="mm-panel-current" class="postbox">
						...
						<div class="toggle<?php if (isset($_GET['settings-updated'])) echo ' default-hidden'; ?>">
							<?php require_once('support-panel.php'); usp_support_panel(); ?>
						</div>
					</div>
				</div>
			</div>
